...
--
-- Host: localhost    Database: bancotechacademy4
-- ------------------------------------------------------
...
CREATE TABLE `pedido_forma` (
  `id_pedidoForma` int(11) NOT NULL,
  `status` varchar(100) DEFAULT NULL,
  `pedido_id` int(11) DEFAULT NULL,
  `forma_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_pedidoForma`),
  KEY `pedido_id` (`pedido_id`),
...
--
-- Dumping routines for database 'bancotechacademy4'
--
...
-- Dump completed on 2024-11-04 22:17:17
