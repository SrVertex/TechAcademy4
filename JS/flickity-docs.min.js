  ...
  (window.utils = window.fizzyUIUtils),
    ...
    (window.filterBind = function (e, t, n, l) {
      e.addEventListener(t, function (e) {
        e.target.matches(n) && l(e);
      });
    });
})();
FlickityDocs["hero-carousel"] = function (e) {
  let l = e.querySelector(".hero-carousel__cell--1"),
    c = l.querySelector(".hero-illustration");
  if (c) {
    let e = document.createElement("img");
    (e.onload = function () {
      c.src = e.src;
    }),
      (e.src = "img/flickity-illustration.gif");
  }
};
...
!(function (i) {
  ...
  (t.prototype.handleEvent = utils.handleEvent),
    (t.prototype.onresize = function () {
      let t = getComputedStyle(this.element, ":after").content;
...
FlickityDocs.append = function (e) {
  ...
  let t = new Flickity(l, { initialIndex: 2 }),
    c = t.cells.length + 1,
...
FlickityDocs["arrow-wiz"] = function (e) {
  let o = e,
    t = o.querySelector("canvas"),
    r = t.getContext("2d"),
    l = t.width,
    i = t.height;
  function a(e, t, o, n, l) {
    l && (r.strokeStyle = l),
      r.beginPath(),
      r.moveTo(e, t),
      r.lineTo(o, n),
  ...
  let x = "hsla(210, 50%, 50%, 0.25)",
    c = "hsla(210, 50%, 50%, 0.5)";
  function n() {
    let e, t;
    for (e = 0; e < 11; e++) {
      var o = 20 * e + 0.5;
      (t = e % 5 ? x : c), a(0, o, l, o, t);
    }
    for (e = 0; e < 11; e++) {
      var n = 20 * e + 0.5;
      (t = e % 5 ? x : c), a(n, 0, n, i, t);
    }
    a(0, i - 0.5, l, i - 0.5, c), a(l - 0.5, 0, l - 0.5, i, c);
  }
  n();
  let y = [],
    u = [];
  for (let t = 0; t < 4; t++) {
    var s = o.querySelector(".arrow-wiz-illo__point--" + t);
    let e = new Draggabilly(s, { containment: !0, grid: [10, 10] });
    s = (function (t, o) {
      return function () {
        var e = h(t);
        (y[o] = e), T();
    ...
    e.on("dragMove", s), u.push(e), (y[t] = h(e));
  }
  function h(e) {
  ...
  function f() {
    r.clearRect(0, 0, l, i),
      n(),
      (r.strokeStyle = "#333"),
      (r.fillStyle = "hsla(0, 0%, 0%, 0.4)"),
      r.beginPath(),
      r.moveTo(2 * y[0].x, 100),
      r.lineTo(2 * y[1].x, 100 - 2 * y[1].y),
      r.lineTo(2 * y[2].x, 100 - 2 * y[2].y),
      r.lineTo(2 * y[3].x, 100),
      r.lineTo(2 * y[2].x, 100 + 2 * y[2].y),
      r.lineTo(2 * y[1].x, 100 + 2 * y[1].y),
      r.lineTo(2 * y[0].x, 100),
      r.fill(),
      r.stroke(),
      r.closePath();
  }
  let v = o.querySelector(".arrow-wiz-code code");
  let w = new Flickity(o.querySelector(".carousel"), { initialIndex: 2 }),
    S = w.prevButton.element.querySelector("path"),
    d = w.nextButton.element.querySelector("path");
  function T() {
    var e;
    f(),
      (v.textContent =
...
FlickityDocs["custom-nav"] = function (e) {
  ...
  let c = new Flickity(t, { prevNextButtons: !1, pageDots: !1 }),
    l = e.querySelector(".button-group--cells"),
    n = utils.makeArray(l.children);
  c.on("select", function () {
    let e = l.querySelector(".is-selected"),
      t = l.children[c.selectedIndex];
  ...
  let i = e.querySelector(".button--previous");
  i.addEventListener("click", function () {
    c.previous();
  });
  let s = e.querySelector(".button--next");
  s.addEventListener("click", function () {
    c.next();
  });
};
FlickityDocs["events-table"] = function (e) {
  let t = e.querySelector(".event-table"),
    d = t.querySelector("tbody");
  e = e.querySelector(".carousel");
  let l = new Flickity(e, {
    on: {
      ready: function () {
        c("ready");
      },
  ...
  function c(e, t) {
    ...
    (l.textContent = i),
      ...
      n.appendChild(o);
    t = d.children;
    1 === t.length ? d.appendChild(n) : d.insertBefore(n, t[1]);
    t = d.children[11];
    t && d.removeChild(t);
  }
  l.on("change", function (e) {
    c("change", "changed to cell " + (e + 1));
  }),
    l.on("select", function (e) {
      c("select", "selected cell " + (e + 1));
    }),
    l.on("settle", function (e) {
      c("settle", "settled at cell " + (e + 1));
    }),
    l.on("staticClick", function (e, t, n, l) {
      c("staticClick", n ? "clicked cell " + l : "");
    }),
    [
      "dragStart",
      "dragMove",
...
FlickityDocs.destroy = function (e) {
  let t = e.querySelector(".carousel"),
    c = new Flickity(t),
    i = !0,
    n = e.querySelector(".button");
  n.addEventListener("click", function () {
...
FlickityDocs.insert = function (e) {
  var t = e.querySelector(".carousel");
  let i = new Flickity(t, { initialIndex: 1 }),
    l = i.cells.length + 1,
...
FlickityDocs.keyhole = function (e) {
  let o =
    ...
    t = e.querySelector(".carousel"),
    r = new Flickity(t, { imagesLoaded: !0 }),
    n = t.querySelectorAll(".keyhole-cell img");
  r.on("scroll", function () {
    r.slides.forEach(function (e, t) {
      let l = n[t];
      e = (-1 * (e.target + r.x)) / 3;
      l.style[o] = "translateX(" + e + "px)";
    });
  });
};
FlickityDocs.next = function (e) {
  var t = e.querySelector(".carousel");
  let n = new Flickity(t),
    c = e.querySelector(".button--next");
  c.addEventListener("click", function () {
    n.next();
  });
  let i = e.querySelector(".button--next-wrapped");
  i.addEventListener("click", function () {
    n.next(!0);
  });
};
FlickityDocs["view-fullscreen-demo"] = function (e) {
  ...
  let l = new Flickity(c, { fullscreen: !0 }),
    n = e.querySelector(".button");
  n.addEventListener("click", function () {
    l.viewFullscreen();
  });
...
FlickityDocs.parallax = function (l) {
  ...
  let r = new Flickity(e),
    a = l.querySelector(".parallax__layer--bg"),
    o = l.querySelector(".parallax__layer--fg");
  function t(l, e, r) {
    l.style.left = 100 * (0.5 - 0.6 * (0.5 + 4 * r) * e) + "%";
  }
  r.on("scroll", function (l) {
    t(a, 0.8, l), t(o, 1.25, l);
  }),
    r.reposition();
};
FlickityDocs.player = function (e) {
  var t = e.querySelector(".carousel");
  let n = new Flickity(t, { autoPlay: 1e3 }),
...
FlickityDocs.prepend = function (e) {
  var l = e.querySelector(".carousel");
  let c = new Flickity(l),
    t = c.cells.length + 1,
    n = FlickityDocs.makeCellElem,
...
FlickityDocs["progress-bar"] = function (r) {
  ...
  let o = r.querySelector(".progress-bar__bar"),
    t = new Flickity(e);
...
FlickityDocs.previous = function (e) {
  var t = e.querySelector(".carousel");
  let i = new Flickity(t),
    r = e.querySelector(".button--previous");
  r.addEventListener("click", function () {
    i.previous();
  });
  let o = e.querySelector(".button--previous-wrapped");
  o.addEventListener("click", function () {
    i.previous(!0);
  });
};
FlickityDocs.reposition = function (i) {
  i = i.querySelector(".carousel");
  let o = new Flickity(i);
  o.on("staticClick", function (i, t, e) {
    e && (e.classList.toggle("is-expanded"), o.reposition());
  });
};
...
FlickityDocs["select-cell"] = function (e) {
  let l = window.fizzyUIUtils,
    t = new Flickity(e.querySelector(".carousel"), { groupCells: !0 }),
    c = e.querySelector(".button-group"),
    i = l.makeArray(c.querySelectorAll(".button"));
  filterBind(c, "click", ".button", function (e) {
    e = i.indexOf(e.target);
    t.selectCell(e);
  });
};
FlickityDocs.select = function (e) {
  let t = window.fizzyUIUtils,
...
FlickityDocs["select-cell-selector"] = function (e) {
  let t = new Flickity(e.querySelector(".carousel"), { groupCells: !0 });
...
FlickityDocs["select-instant"] = function (t) {
  let e = window.fizzyUIUtils,
    i = new Flickity(t.querySelector(".carousel")),
    l = t.querySelector(".button-group"),
    c = e.makeArray(l.querySelectorAll(".button"));
  filterBind(l, "click", ".button", function (t) {
    t = c.indexOf(t.target);
    i.select(t, !1, !0);
  });
};
FlickityDocs["static-click"] = function (c) {
  let t = c.querySelector(".carousel"),
    e = new Flickity(t, { initialIndex: 1 }),
    s = c.querySelector(".logger");
  e.on("staticClick", function (c, e, i, l) {
    if (i) {
      let c = t.querySelector(".is-clicked");
      c && c.classList.remove("is-clicked"),
        i.classList.add("is-clicked"),
        (s.textContent = "Cell " + (l + 1) + " clicked");
    }
  });
};
FlickityDocs.remove = function (e) {
  e = e.querySelector(".carousel");
  let t = new Flickity(e, { initialIndex: 1 });
  t.on("staticClick", function (e, i, c) {
    c && t.remove(c);
  });
};
!(function () {
  var a = document.querySelectorAll("[data-js]");
  for (let l = 0; l < a.length; l++) {
    let t = a[l];
    var c = t.getAttribute("data-js");
    let e = FlickityDocs[c] || FizzyDocs[c];
    e && e(t);
  }
})();
